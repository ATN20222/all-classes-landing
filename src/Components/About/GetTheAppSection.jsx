            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 WhatSectionLeftText" data-aos='fade-left'>
                        ...
                        <span>all classes app is now available on google play and app store Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo maiores soluta ducimus rerum, quae laudantium dicta accusantium eaque tenetur ad quam animi quibusdam fugiat recusandae quo quod? Animi, vel odit!</span>
